...
# Load result files
f <- paste0("data-raw/5_preprocess_baseline_results/results/", list.files("data-raw/5_preprocess_baseline_results/results"))
t1 <- Sys.time()
...
# Save parsed results
saveRDS(res, "data-raw/5_preprocess_baseline_results/sleepsimR_results_parsed.rds")

# Extract parameter estimates from the parsed results ----

# Load data
res <- readRDS("data-raw/5_preprocess_baseline_results/sleepsimR_results_parsed.rds")

# Extract iteration ids
iteration_uid <- map_chr(res, function(x) x$iteration_uid)

# Read scenario data
scen <- read.csv("/home/jasper/GitHubProjects/sleepsimR-api/app/data/scenarios.csv.gz") #%>%
...
# Write to disk
saveRDS(em_mean_est, "data-raw/5_preprocess_baseline_results/data_preprocessed/emission_means_est.rds")
...
# Write to disk
saveRDS(em_var_est, "data-raw/5_preprocess_baseline_results/data_preprocessed/emission_varmu_est.rds")
...
# Write to disk
saveRDS(gam_prob_est, "data-raw/5_preprocess_baseline_results/data_preprocessed/gamma_int_prob.rds")
...
# Write to disk
saveRDS(emiss_mu_cci_est, "data-raw/5_preprocess_baseline_results/data_preprocessed/emiss_mu_cci.rds")
...
# Write to disk
saveRDS(emiss_varmu_cci_est, "data-raw/5_preprocess_baseline_results/data_preprocessed/emiss_varmu_cci.rds")
...
# Write to disk
saveRDS(gamma_prob_cci_est, "data-raw/5_preprocess_baseline_results/data_preprocessed/gamma_prob_cci.rds")
...
saveRDS(tpm, "data-raw/5_preprocess_baseline_results/data_preprocessed/tpm_probs_true_mapval.rds")
